                    ...
                    <div class="col-xl-3 col-md-4">
                        <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover"
                            ...
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                ...
                                <span class="status status-<?php switch ($credentials[$index][0]['status']):
                                    case 1:
                                        echo 'success' ?>
                                 <?php break; ?>
                                 <?php case 2:
                                    ...
                                    <div class="info-card-text flex-1">
                                        <a href="javascript:void(0);"
                                           ...
                                           data-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <?php if ($auth->getUserId() == $user['id'] || $auth->hasRole(\Delight\Auth\Role::ADMIN)): ?>
                                        ...
                                        <?php if ($auth->getUserId() == $user['id'] || $auth->hasRole(\Delight\Auth\Role::ADMIN)): ?>
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                   href="/show_media?id=<?php echo $user['id'] ?>">
